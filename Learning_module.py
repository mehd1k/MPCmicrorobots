...
class LearningModule:
    ...
    def estimateDisturbance(self, px, py, time):
        N = (int)(1 / 0.035 / 2) 
        #filter position data due to noisy sensing
    ...
    def learn(self, px, py, alpha_sim, time, actions):
        ...
        joblib.dump(self.gprX, 'gpX.pkl')
        joblib.dump(self.gprY, 'gpY.pkl')
        np.save('a_sim.npy',a0)
    ...
    def load_GP(self):
        self.gprY = joblib.load('gpY.pkl')
        self.gprX = joblib.load('gpX.pkl')
        print('GP is loaded')
